...
public class ArtistsApiController implements ArtistsApi {
    ...
    public ResponseEntity<Object> addArtist(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Artist artist) {
    ...
    public ResponseEntity<Object> getArtist(@ApiParam(value = "",required=true) @PathVariable("artistId") Long artistId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Object>(objectMapper.readValue("\"\"", Object.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Object> getArtistFilmography(@ApiParam(value = "",required=true) @PathVariable("artistId") Long artistId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Object>(objectMapper.readValue("\"\"", Object.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Object> updateArtist(@ApiParam(value = "",required=true) @PathVariable("artistId") Long artistId,@ApiParam(value = "" ,required=true )  @Valid @RequestBody Artist artist) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Object>(objectMapper.readValue("\"\"", Object.class), HttpStatus.NOT_IMPLEMENTED);
