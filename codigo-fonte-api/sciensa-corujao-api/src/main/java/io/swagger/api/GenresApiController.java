...
public class GenresApiController implements GenresApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(GenresApiController.class);
    ...
    public GenresApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Object> addGenre(@ApiParam(value = "" ,required=true )  @Valid @RequestBody Genre genre) {
    ...
    public ResponseEntity<Object> getGenre(@ApiParam(value = "",required=true) @PathVariable("genreId") Long genreId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Object>(objectMapper.readValue("\"\"", Object.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<Object> updateGenre(@ApiParam(value = "",required=true) @PathVariable("genreId") Long genreId,@ApiParam(value = "" ,required=true )  @Valid @RequestBody Genre genre) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<Object>(objectMapper.readValue("\"\"", Object.class), HttpStatus.NOT_IMPLEMENTED);
